...
print("La distancia que recorrerá en 6 horas son", distancia01, "km")

print("La distancia que recorrerá en 3.5 horas", distancia02, "km")

print("Para recorrer 485 km tardaría", horas, "horas")